...
<header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-7 py-4">
                    ...
                    <p class="text-muted">
                      Welcome to our exquisite haven of serenity, where tranquility reigns supreme, and relaxation is an art form. Our meticulously crafted rooms are designed with a touch of opulence, ensuring an ambiance that transcends the ordinary. Immerse yourself in absolute serenity, 
                    as each corner of our sanctuary provides a haven for those in search of a truly refined and peaceful escape.</p>
                </div>
    ...
    <div class="navbar navbar-dark bg-dark box-shadow box-shadow pt-5 pb-5">
...
<main role="main">
    ...
    <div class="container mt-5 pt-5" id="tableContainer">
...
<footer class="container" style="text-align: center;">
    <p style="margin: 0;">&copy; Company 2020-2023</p>
</footer>
